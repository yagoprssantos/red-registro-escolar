...
const FALLBACK_PLATFORMS = [
  { name: "Google Classroom", description: "Acesse suas turmas, tarefas e materiais digitais.", url: "https://classroom.google.com", emoji: "📚", colorGradient: "from-blue-500 to-blue-700" },
...
export default function StudentPlatforms() {
  const { data: platforms, isLoading } = trpc.profiles.student.platforms.useQuery();
  ...
  return (
    <div className="space-y-6 p-4 md:p-6">
      ...
      <p className="text-sm text-muted-foreground">
        Acesse as plataformas parceiras da escola para complementar seus
        estudos.
      </p>

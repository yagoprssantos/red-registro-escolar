        ...
        <div className="bg-white rounded-lg shadow-2xl p-8 md:p-12">
          ...
          <div className="mb-8">
            ...
            <p className="font-body text-sm text-gray-600 leading-relaxed">
              ...
              demonstrações solicitadas e acompanhar o progresso da implementação do RED.
            </p>
          </div>
          ...
          <button
            onClick={handleLogin}
            className="w-full flex items-center justify-center gap-2 bg-red-brand text-white font-heading font-semibold text-sm py-3.5 rounded-lg hover:bg-[#6b0d19] transition-all duration-200 shadow-lg hover:shadow-xl group mb-4"
          >
            <LogIn size={18} />
            Entrar com Manus

        ...
        <div className="max-w-2xl">
          ...
          >
            <a
              ...
              className="inline-flex items-center gap-2 bg-card text-red-brand font-heading font-semibold text-sm px-8 py-3.5 rounded-lg hover:bg-muted/40 transition-all duration-200 shadow-lg hover:shadow-2xl hover:scale-105 group"
            >
              <LogIn
                size={18}

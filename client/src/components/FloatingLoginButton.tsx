...
export default function FloatingLoginButton() {
  ...
  return (
    <div className="fixed bottom-8 right-8 z-40 flex flex-col items-end gap-3">
      ...
      {/* Main Button */}
      <a
        href="/profile-selector?source=floating-button"
      ...
      <div className="flex items-center gap-2 text-xs text-muted-foreground bg-card px-3 py-2 rounded-full shadow-md">
        <div className="w-8 h-8 rounded-full border-2 border-border flex items-center justify-center relative">
          <div
      ...
      {/* Info Tooltip */}
      <div className="bg-card rounded-lg shadow-lg p-3 max-w-xs text-sm text-muted-foreground border-l-4 border-red-brand">
